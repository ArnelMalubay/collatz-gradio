...
with gr.Blocks() as demo:
    with gr.Row():
        with gr.Column():
            ...
            max_number = gr.Slider(label = 'Specify the maximum number to use for the branches', minimum = 1000, maximum = 20000, value = 500, step = 10, interactive = True)
            slant_angle = gr.Slider(label = 'Specify the slant angle', minimum = 45, maximum = 90, value = 60, step = 5, interactive = True)
            fan_angle = gr.Slider(label = 'Specify the fan angle', minimum = 45, maximum = 90, value = 60, step = 5, interactive = True)
            colormap_choices = ['inferno', 'binary', 'magma', 'cividis', 'viridis', 'plasma', 'Pastel1', 'Pastel2', 'Paired', 'Accent', 'flag', 'prism', 'ocean', 'gist_earth', 'terrain', 'gist_stern', 'rainbow', 'jet', 'turbo', 'gray', 'bone', 'pink', 'spring', 'summer', 'autumn', 'winter', 'cool', 'hot', 'copper', 'Dark2', 'Set1', 'Set2', 'Set3', 'tab10', 'tab20', 'tab20b', 'tab20c']
            colormap = gr.Dropdown(label = 'Choose colormap', choices = colormap_choices, value = 'inferno', interactive = True)
    ...
    submit.click(fn = plot_collatz_sequence, inputs = [max_number, slant_angle, fan_angle, colormap], outputs = image)
